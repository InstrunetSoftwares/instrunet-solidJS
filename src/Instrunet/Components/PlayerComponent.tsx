...
import { createSignal, createEffect, onMount, Accessor, Show, JSX } from "solid-js";
...
const PlayerComponent = ({ url, PlayInfo, onFinished }: { url: Accessor<string>, PlayInfo: Accessor<PlayInfo | null | undefined>, onFinished?: JSX.EventHandlerUnion<HTMLAudioElement, Event, JSX.EventHandler<HTMLAudioElement, Event>> | undefined }) => {
