...
const IsCloudflare = ()=> {
	return window.location.hostname.indexOf("axcwg") !== -1
}
let baseUrl:string = IsCloudflare() ?"https://api-instrunet.axcwg.cn/" : "https://andyxie.cn:8200/";
...
export {baseUrl, Kind, white, WebRoutes, Languages, i18n, immutableChangeOrder, immutableRemoveAt, immutableInsertBefore, dataURLtoBlob, IsCloudflare};
